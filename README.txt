...
a persistence unit "SDPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SD/pom.xml":
...
artifact ("SD.war") is already built. You can build
